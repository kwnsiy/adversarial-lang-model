...
class Generator(nn.Module):
    """Generator """
    def __init__(self, num_emb, emb_dim, hidden_dim, use_cuda, start_idx, padding_idx):
        ...
        self.lstm = nn.GRU(emb_dim, hidden_dim, batch_first=True, dropout=0.0)
